...
class DepartmentUsersExport implements FromCollection, WithHeadings
{
    protected $users;
    ...
    public function collection()
    {
        return $this->users->map(function ($user) {
            return [
                ...
                'Inspector' => $user->department_user->inspector,
                'Hierarchy Level' => $user->department_user->hierarchy_level,
                'Status' => $user->status,
    ...
    public function headings(): array
    {
        return [
            ...
            'User Type', 'Inspector', 'Hierarchy Level',
