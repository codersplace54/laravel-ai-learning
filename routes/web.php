...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::post('update-cooperative-application-noc-certificate', [ApplicationDataCorrectionController::class, 'update_cooperative_application_noc_certificate'])->name('correction.cooperative_application_noc_certificate');
