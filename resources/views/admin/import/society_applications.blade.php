...
<head>
    <meta charset="UTF-8">
    <title>Import Cooperative Society Applications (Excel)</title>
...
<body class="bg-light">
    ...
    <div class="container py-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="h3 mb-0">Import Cooperative Society Applications (Excel)</h1>
        ...
        <div class="card shadow-sm">
            <div class="card-body">
                <form action="{{ route('admin.import.society_applications') }}" method="POST"
